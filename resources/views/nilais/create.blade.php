...
<head>
    ...
    <title>Add New Nilai - NilaiSiswa.com</title>
                    ...
                    <div class="card-body">
                        <form action="{{ route('nilais.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="number" class="form-control @error('matematika') is-invalid @enderror" name="matematika" value="{{ old('matematika') }}" placeholder="Masukkan Nilai">
